...
function renderPokemon(pokemon) {
  ...
  newTxt.setAttribute('class', 'pokemon-card-text');

  newCard.appendChild(newTxt);

  var pokeName = document.createElement('h2');
  pokeName.textContent = pokemon.name;

  newTxt.appendChild(pokeName);

  var pokeNumber = document.createElement('h3');
  pokeNumber.textContent = '#' + pokemon.number;

  newTxt.appendChild(pokeNumber);

  var pokeTxt = document.createElement('p');
  pokeTxt.textContent = pokemon.description;

  newTxt.appendChild(pokeTxt);
